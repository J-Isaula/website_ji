...
![Figura 1: Riesgo y recompensa de cinco activos](im1.PNG){alt="Figura 1: Riesgo y recompensa de cinco activos"}
...
![Figura 2: Dos activos y cualquier combinación](im2.PNG){alt="Figura 2: Dos activos y cualquier combinación"}
...
![Figura 3: Posibilidades de cartera y la frontera eficiente](im3.PNG){alt="Figura 3: Posibilidades de cartera y la frontera eficiente"}
...
![Figura 5: Dos sencillas formas de elegir la mejor cartera eficiente](im4.PNG){alt="Figura 5: Dos sencillas formas de elegir la mejor cartera eficiente"}
...
![Figura 6: Frontera eficiente y las curvas de indiferencia](im5.PNG){alt="Figura 6: Frontera eficiente y las curvas de indiferencia"}
...
![Figura 7: Rentabilidad de las acciones de Walt Disney frente a la rentabilidad del S&P 500.](im6.PNG)
...
![Figura 9: Función de distribución acumulativa inversa para la distribución Normal Estandarizada.](im8.PNG)
...
![Figura 10: La distribución de los rendimientos futuros de las acciones.](im9.PNG)
